...
// 4. Precise Minutes - Feminine representation (matching the noun "דַּקּוֹת")
// With the conjunction "וְ..." attached. Numerals use their bound/construct
// form before the noun (e.g. "שְׁלוֹשׁ דַּקּוֹת", "וַחֲמֵשׁ דַּקּוֹת"), matching
// standard Hebrew usage of a cardinal directly modifying a plural noun.
export const MINUTES_PRECISE_ADDITIVE: Record<number, string> = {
  1: "וְדַקָּה",
  2: "וּשְׁתֵּי דַּקּוֹת",
  3: "וּשְׁלוֹשׁ דַּקּוֹת",
  4: "וְאַרְבַּע דַּקּוֹת",
  5: "וַחֲמֵשׁ דַּקּוֹת",
  6: "וְשֵׁשׁ דַּקּוֹת",
  7: "וְשֶׁבַע דַּקּוֹת",
  8: "וּשְׁמוֹנֶה דַּקּוֹת",
  9: "וְתֵשַׁע דַּקּוֹת",
  10: "וְעֶשֶׂר דַּקּוֹת",
  11: "וְאַחַת עֶשְׂרֵה דַּקּוֹת",
  12: "וּשְׁתֵּים עֶשְׂרֵה דַּקּוֹת",
  13: "וּשְׁלֹשׁ עֶשְׂרֵה דַּקּוֹת",
  14: "וְאַרְבַּע עֶשְׂרֵה דַּקּוֹת",
  15: "וַחֲמֵשׁ עֶשְׂרֵה דַּקּוֹת", // or "וָרֶבַע"
  16: "וְשֵׁשׁ עֶשְׂרֵה דַּקּוֹת",
  17: "וּשְׁבַע עֶשְׂרֵה דַּקּוֹת",
  18: "וּשְׁמוֹנֶה עֶשְׂרֵה דַּקּוֹת",
  19: "וּתְשַׁע עֶשְׂרֵה דַּקּוֹת",
  20: "וְעֶשְׂרִים דַּקּוֹת",
  21: "וְעֶשְׂרִים וְדַקָּה",
  22: "וְעֶשְׂרִים וּשְׁתֵּי דַּקּוֹת",
  23: "וְעֶשְׂרִים וּשְׁלוֹשׁ דַּקּוֹת",
  24: "וְעֶשְׂרִים וְאַרְבַּע דַּקּוֹת",
  25: "וְעֶשְׂרִים וַחֲמֵשׁ דַּקּוֹת",
  26: "וְעֶשְׂרִים וְשֵׁשׁ דַּקּוֹת",
  27: "וְעֶשְׂרִים וְשֶׁבַע דַּקּוֹת",
  28: "וְעֶשְׂרִים וּשְׁמוֹנֶה דַּקּוֹת",
  29: "וְעֶשְׂרִים וְתֵשַׁע דַּקּוֹת",
  30: "וָחֵצִי", // keep "וָחֵצִי" for 30 even in precise as it's the natural way
  31: "וּשְׁלֹשִׁים וְדַקָּה",
  32: "וּשְׁלֹשִׁים וּשְׁתֵּי דַּקּוֹת",
  33: "וּשְׁלֹשִׁים וּשְׁלוֹשׁ דַּקּוֹת",
  34: "וּשְׁלֹשִׁים וְאַרְבַּע דַּקּוֹת",
  35: "וּשְׁלֹשִׁים וַחֲמֵשׁ דַּקּוֹת",
  36: "וּשְׁלֹשִׁים וְשֵׁשׁ דַּקּוֹת",
  37: "וּשְׁלֹשִׁים וְשֶׁבַע דַּקּוֹת",
  38: "וּשְׁלֹשִׁים וּשְׁמוֹנֶה דַּקּוֹת",
  39: "וּשְׁלֹשִׁים וְתֵשַׁע דַּקּוֹת",
};
...
export const MINUTES_PRECISE_SUBTRACTIVE: Record<number, string> = {
  ...
  13: "שְׁלֹשׁ עֶשְׂרֵה דַּקּוֹת",
  14: "אַרְבַּע עֶשְׂרֵה דַּקּוֹת",
  15: "רֶבַע", // or "חֲמֵשׁ עֶשְׂרֵה דַּקּוֹת"
...
export function getPeriodOfDay(h: number): string {
  // 05:00 - 11:59 -> בַּבֹּקֶר
  if (h >= 5 && h < 12) {
    return "בַּבֹּקֶר";
  }
  // 12:01 - 16:59 -> בַּצָּהֳרַיִם
  if (h >= 12 && h < 17) {
    return "בַּצָּהֳרַיִם";
  }
  // 17:00 - 21:59 -> בָּעֶרֶב
  if (h >= 17 && h < 22) {
    return "בָּעֶרֶב";
  }
  // 22:00 - 04:59 -> בַּלַּיְלָה
  // Special poetic option: "לִפְנוֹת בֹּקֶר" between 02:00 and 05:00 (i.e. 2, 3, 4)
  if (h >= 2 && h < 5) {
...
export function convertTimeToHebrewWords(
  ...
  if (precise) {
    ...
    if (minutes === 0) {
      ...
      return `${getHourName(hours)} בְּדִיּוּק ${getPeriodOfDay(hours)}`;
    }
    ...
    // If nextHour is midnight (0), we don't need period of day "לַחֲצוֹת בַּלַּיְלָה" is redundant, "לַחֲצוֹת" is enough.
    if (nextHour === 0) {
    ...
    // Additive (roundedMinutes < 35): past that point "half past and five
    // more" reads as clumsy Hebrew, so switch to the subtractive ("25
    // minutes to X") phrasing a half-step earlier than precise mode does.
